  ...
  <v-container>
    <v-main>
      ...
      <v-row align="center" justify="center" >
                    ...
                    <v-col cols="12" md="6" class="blue rounded-br-xl">
                     <div style="  text-align: center; padding: 180px 0;">
                      <v-card-text class="white--text" >
                        ...
                        <h6
                          class="text-center"
                        >Log in to your Admin page and<br> register your attendance </h6>
                      </v-card-text>
       ...
       <v-snackbar top color="green" v-model="snack">
                    {{snackData}}
                  </v-snackbar>
  </v-container>
...
import axios from 'axios'
  ...
  methods: {
      ...
      axios.post('https://qr-scan3.herokuapp.com/api/auth/signup', { 
                "username" : this.email,
                "email": this.email,
            ...
            if(response.statusCode===200){
             ...
             if(error.response.status===400){
              console.log("hello");
              this.snackData="User already registred";
             this.snack=true;
